...
"[Notebook 00 -- DRIADA overview](https://colab.research.google.com/github/iabs-neuro/driada/blob/dev/notebooks/00_driada_overview.ipynb).\n"
"\n"
...
"ax.plot(time_cmp, n_wvt.reconstructed.data, 'b', linewidth=1.2,\n"
...
"ax = axes[2]\n"
"ax.plot(time_cmp, signal_cmp, 'k', linewidth=0.5, alpha=0.4)\n"
"ax.plot(time_cmp, n_thr.reconstructed.data, 'r', linewidth=1.2,\n"
