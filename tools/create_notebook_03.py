...
Assembles content from 6 validated examples into a single Colab-ready
Jupyter notebook using nbformat.

Source examples:
  1. examples/dr_simplified_api/dr_simplified_api_demo.py
  2. examples/compare_dr_methods/compare_dr_methods.py
  3. examples/dr_sequence/dr_sequence_neural_example.py
  4. examples/autoencoder_dr/autoencoder_dr.py
  5. examples/circular_manifold/extract_circular_manifold.py
  6. examples/intense_dr_pipeline/intense_dr_pipeline.py
"""
...
"DR via [`get_embedding`](https://driada.readthedocs.io/en/latest/api/dim_reduction/data_structures.html#driada.dim_reduction.data.MVData.get_embedding). Seven methods are available: **PCA**, **Isomap**, **LLE**,\n"
"**Laplacian Eigenmaps**, and **UMAP**. For multi-step\n"
"pipelines, see [`dr_sequence`](https://driada.readthedocs.io/en/latest/api/dim_reduction/algorithms.html#driada.dim_reduction.sequences.dr_sequence).\n"
"\n"
"```python\n"
...
"\n"
"- [`knn_preservation_rate`](https://driada.readthedocs.io/en/latest/api/dim_reduction/manifold_metrics.html#driada.dim_reduction.manifold_metrics.knn_preservation_rate) -- fraction of original k nearest neighbors preserved in the embedding.\n"
"- [`trustworthiness`](https://driada.readthedocs.io/en/latest/api/dim_reduction/manifold_metrics.html#driada.dim_reduction.manifold_metrics.trustworthiness) -- fraction of embedding neighbors that are true neighbors in the original space.\n"
"- [`continuity`](https://driada.readthedocs.io/en/latest/api/dim_reduction/manifold_metrics.html#driada.dim_reduction.manifold_metrics.continuity) -- fraction of true neighbors that remain neighbors in the embedding.\n"
"- [`stress`](https://driada.readthedocs.io/en/latest/api/dim_reduction/manifold_metrics.html#driada.dim_reduction.manifold_metrics.stress) -- normalized Frobenius distance between the original and embedded distance matrices.\n"
"\n"
"For a single composite score, use [`manifold_preservation_score`](https://driada.readthedocs.io/en/latest/api/dim_reduction/manifold_metrics.html#driada.dim_reduction.manifold_metrics.manifold_preservation_score)."
))
...
# ===== SECTION 3: SEQUENTIAL DR ON NEURAL DATA ============================
...
# ===== SECTION 4: AUTOENCODER-BASED DR ====================================
...
"[`generate_circular_manifold_exp`](https://driada.readthedocs.io/en/latest/api/experiment/synthetic.html#driada.experiment.generate_circular_manifold_exp), estimate\n"
"the intrinsic dimensionality ([`pca_dimension`](https://driada.readthedocs.io/en/latest/api/dimensionality/linear.html#driada.dimensionality.linear.pca_dimension) scree,\n"
"[`correlation_dimension`](https://driada.readthedocs.io/en/latest/api/dimensionality/intrinsic.html#driada.dimensionality.intrinsic.correlation_dimension),\n"
"[`geodesic_dimension`](https://driada.readthedocs.io/en/latest/api/dimensionality/intrinsic.html#driada.dimensionality.intrinsic.geodesic_dimension),\n"
"[`eff_dim`](https://driada.readthedocs.io/en/latest/api/dimensionality/effective.html#driada.dimensionality.effective.eff_dim) participation ratio), compare real vs\n"
"shuffled data, and extract the circular manifold via DR\n"
"([`visualize_circular_manifold`](https://driada.readthedocs.io/en/latest/api/utils/visualization.html#driada.utils.visual.visualize_circular_manifold))."
))
...
"## 6. INTENSE-guided DR\n"
"\n"
"Use [`compute_cell_feat_significance`](https://driada.readthedocs.io/en/latest/api/intense/pipelines.html#driada.intense.pipelines.compute_cell_feat_significance) (INTENSE) to identify spatially selective neurons\n"
"from a [`generate_mixed_population_exp`](https://driada.readthedocs.io/en/latest/api/experiment/synthetic.html#driada.experiment.generate_mixed_population_exp) dataset, then compare DR\n"
