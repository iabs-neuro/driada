...
Jupyter notebook using nbformat.  The shared setup (synthetic data +
cell-cell significance + Network construction) is done once; both
structural and spectral analyses operate on the same network.

Source examples:
  1. examples/network_analysis/cell_cell_network_example.py
  2. examples/network_spectrum/network_spectrum_example.py
"""
...
"# Functional networks\n"
"\n"
"Build cell-cell interaction networks from calcium imaging data using\n"
"significance testing, then analyze their structure and spectral\n"
"properties.\n"
"\n"
