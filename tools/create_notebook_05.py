...
"embedding against known head direction angles)."
))
...
"- `compute_rdm_unified` -- RDM from neural data + condition labels\n"
"- `rsa_compare` -- Compare two populations directly\n"
"- `compare_rdms` -- Correlate two pre-computed RDMs\n"
"- `bootstrap_rdm_comparison` -- Statistical significance via bootstrap\n"
...
"\n"
"RSA works seamlessly with `MVData` objects from the DR pipeline. Pass\n"
