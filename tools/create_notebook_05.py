...
"\n"
"Combining INTENSE + DR for deeper analysis, comparing representations\n"
"across conditions, and applying DRIADA beyond calcium imaging. Builds\n"
"on concepts from Notebooks 2--4.\n"
"\n"
"**Sections:**\n"
"\n"
...
"\n"
"Key APIs:\n"
"- [`compute_embedding_selectivity`](https://driada.readthedocs.io/en/latest/api/dim_reduction/neural_methods.html) -- INTENSE on embedding components.\n"
...
"- [`get_functional_organization`](https://driada.readthedocs.io/en/latest/api/dim_reduction/neural_methods.html) -- cluster and participation analysis\n"
"- [`compare_embeddings`](https://driada.readthedocs.io/en/latest/api/dim_reduction/neural_methods.html) -- cross-method comparison\n"
"\n"
