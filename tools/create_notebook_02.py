...
"\n"
"if significant_neurons:\n"
"    # Find first univariate (TimeSeries) pair for visualization\n"
"    # (plot_neuron_feature_pair expects 1D features, not MultiTimeSeries)\n"
"    plot_cell_id, plot_feat = None, None\n"
"    for cell_id, features in significant_neurons.items():\n"
"        for feat_name in features:\n"
"            feat = exp.dynamic_features.get(feat_name)\n"
"            if feat is not None and not isinstance(feat, MultiTimeSeries):\n"
"                plot_cell_id, plot_feat = cell_id, feat_name\n"
"                break\n"
...
"        driada.intense.plot_neuron_feature_pair(\n"
"            exp, plot_cell_id, plot_feat, ax=ax\n"
"        )\n"
"        plt.title(f\"Neuron {plot_cell_id} selectivity to {plot_feat}\")\n"
"        plt.tight_layout()\n"
"        plt.show()\n"
"    else:\n"
"        print(\"   No univariate feature pairs found for visualization\")\n"
"else:\n"
