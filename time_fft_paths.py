"""Time individual FFT paths to find the bottleneck."""
import numpy as np
import time
import sys
...
np.random.seed(42)
n = 3600  # Typical downsampled length
nsh = 100  # Stage 1 shuffles
...
print(f"Data length: {n}, shuffles: {nsh}")
print("=" * 60)
...
print("\n" + "=" * 60)
print("Summary: If overhead is small (<10%), the issue is elsewhere.")
