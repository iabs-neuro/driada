...
from driada.network.matrix_utils import symmetric_component, non_symmetric_component
...
class TestCompleteGraphRandomization:
    ...
    def test_complete_basic(self, complete_graph):
        ...
        result = random_rewiring_complete_graph(
            complete_graph,
            p=1.0,
            random_state=42
        )
