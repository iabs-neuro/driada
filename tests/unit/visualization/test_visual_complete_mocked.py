...
class TestVisualFunctionsCompletelyMocked:
    ...
    def test_plot_pc_activity(self, mock_experiment):
        ...
        with patch('driada.intense.visual.create_default_figure') as mock_create_fig, \
    ...
    def test_edge_cases(self, mock_experiment):
        ...
        with patch('matplotlib.pyplot.subplots') as mock_subplots:
            ...
            mock_experiment.get_neuron_feature_pair_stats = lambda *args, **kwargs: {'me': 0.1, 'pval': 0.1}
