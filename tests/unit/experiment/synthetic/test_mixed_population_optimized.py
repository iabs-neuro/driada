...
class TestGenerateMixedPopulationExpFast:
    ...
    def test_edge_cases(self):
        ...
        total = info['population_composition']['n_manifold'] + info['population_composition']['n_feature_selective']
        assert total == 1
