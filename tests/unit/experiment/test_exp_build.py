...
class TestLoadExpFromAlignedData:
    ...
    def test_basic_loading(self, basic_data, exp_params):
        ...
        with patch('driada.experiment.exp_build.construct_session_name', return_value='test_exp'):
    ...
    def test_reconstruct_spikes_parameter(self, exp_params):
        ...
        with patch('driada.experiment.exp_build.construct_session_name', return_value='test'):
            with patch('driada.experiment.exp_base.Experiment.__init__', return_value=None) as mock_init:
                load_exp_from_aligned_data(
                    'source', exp_params, data,
...
class TestLoadExperiment:
    ...
    def test_non_iabs_source(self, temp_dir):
        ...
        with pytest.raises(NotImplementedError, match='Other data sources are not yet supported'):
    ...
    def test_custom_paths(self, temp_dir):
        ...
        exp, log = load_experiment(
            'IABS', {'track': 'HT', 'animal_id': 'test', 'session': '1'},
            root=temp_dir,
