"""Test INTENSE detection with stage2 and relaxed parameters."""
import numpy as np
...
print("- Using two_stage mode with reduced shuffles")
...
stats, significance, info, intense_results = compute_cell_feat_significance(
    ...
    n_shuffles_stage2=200,  # Reduced from 500
...
if mixed_selectivity_neurons:
    ...
    print(f"\nNo mixed selectivity detected - checking individual significant neurons:")
