...
class TestGenerateMixedPopulationExp:
    ...
    def test_manifold_types(self):
        ...
        for manifold_type in manifold_types:
            ...
            if manifold_type == "circular":
                ...
                assert isinstance(
                    exp.dynamic_features["circular_angle"], MultiTimeSeries
                )
    ...
    def test_parameter_validation(self):
        ...
        with pytest.raises(
            ValueError, match="manifold_fraction must be between 0.0 and 1.0"
        ):
        ...
        with pytest.raises(
            ValueError, match="correlation_strength must be between 0.0 and 1.0"
        ):
    ...
    def test_reproducibility(self):
        ...
        exp1, info1 = generate_mixed_population_exp(
            n_neurons=20, seed=123, verbose=False, return_info=True
        )
        ...
        exp3, info3 = generate_mixed_population_exp(
            n_neurons=20, seed=456, verbose=False, return_info=True
        )
...
class TestMixedPopulationIntegration:
    ...
    def test_experiment_methods_work(self):
        ...
        exp, info = generate_mixed_population_exp(
            n_neurons=15, duration=30, seed=42, verbose=False, return_info=True
        )
        ...
        calcium_subset = exp.calcium.data[
            :5, :100
        ]  # First 5 neurons, first 100 timepoints
