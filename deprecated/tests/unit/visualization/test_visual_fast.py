...
class TestVisualFunctions:
    ...
    def test_plot_neuron_feature_density(self, mock_subplots, visual_experiment):
        ...
        ax = plot_neuron_feature_density(
            visual_experiment, "calcium", 0, "speed", ind1=0, ind2=100
        )
        assert ax is not None
    ...
    def test_edge_cases_with_mocking(self, visual_experiment):
        ...
        with patch("matplotlib.pyplot.subplots") as mock_subplots:
            ...
            ax = plot_neuron_feature_density(
                visual_experiment, "calcium", 0, "speed", ind1=0, ind2=5
            )
            assert ax is not None
            ...
            fig, ax = plot_disentanglement_heatmap(
                disent_matrix, zero_count, feat_names
            )
            assert fig is not None
...
class TestVisualPerformance:
    ...
    def test_all_functions_fast(self, mock_subplots, visual_experiment):
        ...
        functions_to_test = [
            ...
            lambda: plot_neuron_feature_density(
                visual_experiment, "calcium", 0, "speed"
            ),
